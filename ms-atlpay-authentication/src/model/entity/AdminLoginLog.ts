...
export class AdminLoginLog {
  ...
  @ManyToOne(() => AdminAuthentication, (adminAuthentication) =>
    adminAuthentication.id, {onDelete: 'SET NULL'})
  ...
  */
  ...
  /**
  * Getter Asn TypeadminAuthentication
