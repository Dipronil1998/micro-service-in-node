import {
  ...
  /**
   * Civil Status class
   * @class{DocumentRejectReason}
   */
  @Entity({name: 'document_reject_reasons'})
  /**
    * Entity for storing DocumentRejectReason developed in typeORM
    * @Entity DocumentRejectReason
    */
export class DocumentRejectReason {
  ...
  private _id: string;
      ...
      /**
       * Setter Require Note
       * @return{number} requireNote
       */
      public get requireNote(): boolean {
        return this._requireNote;
      }

      /**
       * Setter Require Note
       * @param{number} requireNote
       */
      public set requireNote(requireNote: boolean) {
        this._requireNote= requireNote;
      }
