import {HTTP_APP_CREDENTIALS_NOT_PRESENT,
  ...
  HTTP_SUCCESS_MESSAGE_MERCHANT_CREATED,
...
describe('Test cases for Constant', () => {
  ...
  test('test cases for HTTP Success Message merchant created', () => {
    expect(HTTP_SUCCESS_MESSAGE_MERCHANT_CREATED)
        .toEqual(
            // eslint-disable-next-line
            'Merchant account created successfully and it is underverification');
    expect(HTTP_SUCCESS_MESSAGE_MERCHANT_CREATED)
        .not
        .toEqual('Merchant account created successfully');
  });
