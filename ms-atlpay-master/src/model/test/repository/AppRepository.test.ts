...
import {BelongsTo} from '../../assocaition/BelongsTo';
import {HasOne} from '../../assocaition/HasOne';
import {HasMany} from '../../assocaition/HasMany';
import {BelongsToMany} from '../../assocaition/BelongsToMany';
...
describe('Test cases of Different functionality of AppRepository', () => {
  ...
  test('To Json with delete attributes', ()=>{
    ...
    const modifiedNestedEntity = currencyRepo.toJson(nestedEntity);
